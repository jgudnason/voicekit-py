...
(the Atal-Rabiner voicing-analysis standard). Durations are held in milliseconds
...
class VoicingGrid:
    ...
    frame_dur_s: float = 0.032  # frame length (s) -- Atal-Rabiner wl
    hop_dur_s: float = 0.010  # hop / frame step (s) -- Atal-Rabiner inc
